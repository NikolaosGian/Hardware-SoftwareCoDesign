...
// ==============================================================
#ifndef __MATRIX_MUL_mac_mueOg__HH__
#define __MATRIX_MUL_mac_mueOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(MATRIX_MUL_mac_mueOg) {
    ...
    SC_CTOR(MATRIX_MUL_mac_mueOg):  simcore_mac_1_U ("simcore_mac_1_U") {
