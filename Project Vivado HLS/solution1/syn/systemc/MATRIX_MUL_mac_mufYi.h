...
// ==============================================================
#ifndef __MATRIX_MUL_mac_mufYi__HH__
#define __MATRIX_MUL_mac_mufYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(MATRIX_MUL_mac_mufYi) {
    ...
    SC_CTOR(MATRIX_MUL_mac_mufYi):  simcore_mac_2_U ("simcore_mac_2_U") {
