...
// ==============================================================
#ifndef __MATRIX_MUL_mac_mudEe__HH__
#define __MATRIX_MUL_mac_mudEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(MATRIX_MUL_mac_mudEe) {
    ...
    SC_CTOR(MATRIX_MUL_mac_mudEe):  simcore_mac_0_U ("simcore_mac_0_U") {
